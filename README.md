...
Clone the repository:
    ...
    git clone [[repository_url]](https://github.com/AkitaEngineering/Akita-Dynamic-DDNS-for-Reticulum) #
...
Configure: Create `akita_config.yaml` in the project root.  
Crucially, set `akita_namespace_identity_hash` to a unique, shared hash for all nodes participating in your Akita DDNS network.  
Refer to the example config file for details.
...
Please refer to `docs/testing.md` for testing information.  
Submit pull requests or open issues on the project repository.
